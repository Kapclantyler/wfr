...
local l_presents_0 = require(script:WaitForChild("presents"));
local v2 = {
    ["Desolate Deep"] = {
        Trash = 22, 
        Common = 22, 
...
local v5 = {
    ...
    ["Sea Leviathan"] = {
        ...
        Rarity = "Exotic", 
        Resilience = 4, 
        Description = "Some reference this gigantic beast as the king of the sea...", 
        Hint = "Search the ocean!", 
        FavouriteBait = "Shark Head", 
        FavouriteTime = nil, 
        Price = 12000, 
        XP = 8000, 
    ...
    ToInteger = function(_, v4) --[[ Line: 14627 ]] --[[ Name: ToInteger ]]
        return math.floor(v4.r * 255) * 65536 + math.floor(v4.g * 255) * 256 + math.floor(v4.b * 255);
    end
};
v5.ToHex = function(_, v7) --[[ Line: 14631 ]] --[[ Name: ToHex ]]
    -- upvalues: v5 (copy)
    local v8 = v5:ToInteger(v7);
    local v9 = "";
    local v10 = {
        "A", 
        "B", 
